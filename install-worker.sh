...
DD_INSTALL_ONLY=true DD_API_KEY=4c89809db3c0727e51deed8064c46f9d bash -c "$(curl -L https://raw.githubusercontent.com/DataDog/datadog-agent/master/cmd/agent/install_script.sh)"
